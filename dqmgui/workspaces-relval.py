...
#server.workspace('DQMContent', 12, 'Data', 'Hcal' , '(^Hcal(|NoiseRatesD|RecHitsD)|^CaloTowersD)/', '')
server.workspace('DQMContent', 12, 'Data', 'Hcal' , '(^Hcal(|NoiseRatesD|RecHitsD)|^CaloTowersD)/', 'DataLayouts/Hcal') #modified by spandey
...
server.workspace('DQMContent', 32, 'Monte Carlo', 'MC Hcal' , '(^Hcal(|NoiseRatesD|RecHitsD|DigisV|HitsV)|^CaloTowersD)/', '')
